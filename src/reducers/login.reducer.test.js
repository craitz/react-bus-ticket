...
describe('login reducer', () => {
  ...
  it('deve resetar o estado', () => {
    expect(reducer(initialState, { type: 'RESET_LOGIN' }))
      .toEqual(initialState);
  });
  ...
  it('deve mudar o e-mail dirty', () => {
    expect(reducer(initialState, { type: 'SET_LOGIN_EMAIL_DIRTY' }))
  ...
  it('deve mudar a senha dirty', () => {
    expect(reducer(initialState, { type: 'SET_LOGIN_SENHA_DIRTY' }))
